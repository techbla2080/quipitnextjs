     ...
     <div className="p-3 flex-1 flex justify-center overflow-y-auto">
       <div className="space-y-2 w-full">
         ...
         <div className="mt-6 border-t pt-4">
           <h2 className="px-3 text-xs font-semibold text-black mb-3 uppercase tracking-wider">
             Saved Trips
           </h2>
               ...
               savedTrips.map((trip) => {
                 ...
                 return (
                   <SavedTripItem
                     ...
                     onDelete={(e) => handleDeleteTrip(e, trip.job_id)}
                   />
                 );
               })
             ) : (
               <p className="px-3 text-xs text-gray-500">No saved trips yet</p>
             )}
           </div>
         </div>
       </div>
